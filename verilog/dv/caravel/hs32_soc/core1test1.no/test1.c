...
void main()
{
	...
	((volatile uint32_t*) 0x30000000)[2] = 0x20201000;
	((volatile uint32_t*) 0x30000000)[3] = 0x60001000;
	...
	((volatile uint32_t*) 0x30000000)[8] = 0x20505800;
	((volatile uint32_t*) 0x30000000)[9] = 0x24500000;
	((volatile uint32_t*) 0x30000000)[10] = 0x30530000;
	((volatile uint32_t*) 0x30000000)[11] = 0x24400BAD;
	((volatile uint32_t*) 0x30000000)[12] = 0x24502166;
	((volatile uint32_t*) 0x30000000)[13] = 0x20505800;
	((volatile uint32_t*) 0x30000000)[14] = 0x24500000;
	((volatile uint32_t*) 0x30000000)[15] = 0x30540000;
	((volatile uint32_t*) 0x30000000)[16] = 0x68001000;
	((volatile uint32_t*) 0x30000000)[17] = 0x52000BAD;
	((volatile uint32_t*) 0x30000000)[18] = 0x68012000;
	((volatile uint32_t*) 0x30000000)[19] = 0x59000B09;
	((volatile uint32_t*) 0x30000000)[20] = 0x20706800;
