...
void main()
{
	...
	// Write
	((volatile uint32_t*) 0x30000000)[0] = 0x240003F1;
	((volatile uint32_t*) 0x30000000)[1] = 0x20100080;
	((volatile uint32_t*) 0x30000000)[2] = 0x202000A0;
	((volatile uint32_t*) 0x30000000)[3] = 0x203000C0;
	((volatile uint32_t*) 0x30000000)[4] = 0x204000E0;
	((volatile uint32_t*) 0x30000000)[5] = 0x50000000;
